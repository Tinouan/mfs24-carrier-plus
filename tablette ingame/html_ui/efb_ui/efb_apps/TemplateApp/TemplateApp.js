...
(() => {
  ...
  var _TT = class _TT extends import_msfs_sdk.DisplayComponent {
    ...
    _reloadText() {
      ...
      (_a13 = this.props.arguments) == null ? void 0 : _a13.forEach((argumentValue, argumentKey) => {
    ...
    render() {
      var _a13;
      const Tag2 = (_a13 = this.props.type) != null ? _a13 : "span";
      const _b = this.props, { key: _key, type: _type, format: _format, children: _children } = _b, props = __objRest(_b, ["key", "type", "format", "children"]);
      return /* @__PURE__ */ import_msfs_sdk.FSComponent.buildComponent(Tag2, __spreadValues({ ref: this.ref }, props));
    }
    onAfterRender(node) {
      var _a13;
      super.onAfterRender(node);
    ...
    destroy() {
      ...
      (_a13 = this.reloadSubscription) == null ? void 0 : _a13.destroy();
      ...
      return /* @__PURE__ */ import_msfs_sdk.FSComponent.buildComponent(
        ...
        /* @__PURE__ */ import_msfs_sdk.FSComponent.buildComponent(
          TT,
          {
            ...
            format: (_a13 = this.props.format) != null ? _a13 : "uppercase",
  ...
  var _SamplePage = class _SamplePage extends GamepadUiView {
    ...
    render() {
      return /* @__PURE__ */ import_msfs_sdk2.FSComponent.buildComponent("div", { ref: this.gamepadUiViewRef, class: "sample-page", style: `--color: ${this.props.color}` }, /* @__PURE__ */ import_msfs_sdk2.FSComponent.buildComponent("div", { class: "header" }, /* @__PURE__ */ import_msfs_sdk2.FSComponent.buildComponent(
        TTButton,
        {
          key: "Go back",
          type: "secondary",
      ...
      ), /* @__PURE__ */ import_msfs_sdk2.FSComponent.buildComponent("h2", null, this.props.title)), /* @__PURE__ */ import_msfs_sdk2.FSComponent.buildComponent("div", { class: "content" }, /* @__PURE__ */ import_msfs_sdk2.FSComponent.buildComponent(
        TTButton,
        {
          key: "Open page 1",
          callback: () => {
  ...
  var _TemplateAppView = class _TemplateAppView extends AppView {
     ...
     */
    registerViews() {
      this.appViewService.registerPage("SamplePage1", () => /* @__PURE__ */ import_msfs_sdk4.FSComponent.buildComponent(SamplePage, { appViewService: this.appViewService, color: "#7f8fa6", title: "Page 1" }));
      this.appViewService.registerPage("SamplePage2", () => /* @__PURE__ */ import_msfs_sdk4.FSComponent.buildComponent(SamplePage, { appViewService: this.appViewService, color: "#353b48", title: "Page 2" }));
