...
const COMMUNITY_DIR = 'C:\\Users\\tinou\\AppData\\Local\\Packages\\Microsoft.Limitless_8wekyb3d8bbwe\\LocalCache\\Packages\\Community2024\\world-of-aircraft-efb\\html_ui\\efb_ui\\efb_apps\\WorldOfAircraft';
const PACKAGES_DIR = path.join(__dirname, '..', '..', 'Packages', 'world-of-aircraft-efb', 'html_ui', 'efb_ui', 'efb_apps', 'WorldOfAircraft');

// Files to copy
const FILES_TO_COPY = ['WorldOfAircraft.js', 'WorldOfAircraft.css'];
...
// Main
console.log('=======================================');
console.log('  World of Aircraft - Watch & Deploy');
console.log('=======================================\n');

// Initial copy
if (fs.existsSync(path.join(DIST_DIR, 'WorldOfAircraft.js'))) {
  copyFiles();
}
