...
const COMMUNITY_DIR = 'C:\\Users\\tinou\\AppData\\Local\\Packages\\Microsoft.Limitless_8wekyb3d8bbwe\\LocalCache\\Packages\\Community2024\\mfs-carrierplus-efb\\html_ui\\efb_ui\\efb_apps\\CarrierPlus';
const PACKAGES_DIR = path.join(__dirname, '..', '..', 'Packages', 'mfs-carrierplus-efb', 'html_ui', 'efb_ui', 'efb_apps', 'CarrierPlus');

// Files to copy
const FILES_TO_COPY = ['CarrierPlus.js', 'CarrierPlus.css'];
...
// Main
console.log('=======================================');
console.log('  MFS Carrier+ - Watch & Deploy');
console.log('=======================================\n');

// Initial copy
if (fs.existsSync(path.join(DIST_DIR, 'CarrierPlus.js'))) {
  copyFiles();
}
