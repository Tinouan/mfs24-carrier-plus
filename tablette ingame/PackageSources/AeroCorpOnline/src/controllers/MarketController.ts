...
export class MarketController {
  ...
  public async fetchMarketData(): Promise<void> {
    ...
    try {
      ...
      console.log("[ACO] Market loaded:", listings.length, "listings");

      this.renderMarketTab();

    } catch (error) {
      console.error("[ACO] Error fetching market data:", error);
  ...
  private openMarketBuyPopup(locationId: string, itemId: string): void {
    ...
    if (!item) {
      console.error("[ACO] Market item not found");
      return;
    }
  ...
  public async fetchWallets(): Promise<void> {
    try {
      ...
      console.error("[ACO] Error fetching wallets:", error);
    }
  }
  ...
  public async fetchMySellOrders(): Promise<void> {
    ...
    try {
      ...
      console.error("[ACO] Error fetching sell orders:", error);
    }
  }
  ...
  public async cancelSellOrder(orderId: string): Promise<void> {
    ...
    try {
      ...
      console.error("[ACO] Error cancelling sell order:", error);
    }
  }
  ...
  public async fetchMarketInventory(): Promise<void> {
    ...
    try {
      ...
      console.error("[ACO] Error fetching market inventory:", error);
    } finally {
  ...
  public async openSellItemPopupHandler(preSelectedItemCode?: string, preSelectedAirport?: string): Promise<void> {
    ...
    try {
      ...
      console.error("[ACO] Error opening sell item popup:", error);
    }
  }
  ...
  private async confirmSellItem(item: SellableItem, qty: number, price: number, ownerType: "player" | "company"): Promise<void> {
    ...
    try {
      ...
      console.log("[ACO] Sell order posted:", item.item_name, qty, "x", price, "CR");

      closeSellItemPopup();
      void this.fetchMySellOrders();
      void this.fetchWallets();
    } catch (error) {
      console.error("[ACO] Error posting sell order:", error);
    }
  }
  ...
  private async openSellAircraftPopupHandler(aircraftId: string): Promise<void> {
    ...
    try {
      ...
      if (!ac) {
        console.error("[ACO] Aircraft not found:", aircraftId);
        return;
      }

      if (ac.has_cargo) {
        console.warn("[ACO] Aircraft has cargo, cannot sell");
        return;
      }
      ...
      console.error("[ACO] Error opening aircraft sell popup:", error);
    }
  }
  ...
  private async confirmQuickSellAircraft(aircraftId: string): Promise<void> {
    ...
    try {
      ...
      console.log("[ACO] Aircraft sold (quick) for:", saleValue, "CR");
      ...
      console.error("[ACO] Error quick-selling aircraft:", error);
    }
  }
  ...
  private async confirmMarketSellAircraft(aircraftId: string, askingPrice: number): Promise<void> {
    ...
    try {
      ...
      console.log("[ACO] Aircraft sell order posted at:", askingPrice, "CR");
      ...
      console.error("[ACO] Error posting aircraft sell order:", error);
    }
  }
  ...
  public async fetchAircraftCatalog(): Promise<void> {
    ...
    try {
      ...
      console.error("[ACO] Error fetching aircraft catalog:", error);
    }
  }
  ...
  public async purchaseAircraft(catalogId: string, ownerType: "player" | "company"): Promise<void> {
    ...
    try {
      ...
      console.log("[ACO] Aircraft purchased:", newAircraft.registration);
      ...
      console.error("[ACO] Error purchasing aircraft:", error);
    }
  }
  ...
  public async fetchProfileInventory(): Promise<void> {
    ...
    try {
      ...
      console.log("[ACO] Profile inventory loaded:", items.length, "items");

      this.renderProfileInventory();

    } catch (error) {
      console.error("[ACO] Error fetching profile inventory:", error);
    } finally {
