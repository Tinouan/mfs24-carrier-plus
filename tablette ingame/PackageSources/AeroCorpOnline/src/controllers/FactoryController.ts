...
export class FactoryController {
  ...
  refresh(): void {
    // Check if a factory was selected externally (e.g., from map popup)
    const externalId = factoryState.selectedFactoryId.get();
    if (externalId) {
      factoryState.selectedFactoryId.set(null);
      void this.renderFactoryList();
      void this.showFactoryDetail(externalId);
      return;
    }
    void this.renderFactoryList();
