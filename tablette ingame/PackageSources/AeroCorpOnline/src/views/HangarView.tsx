      ...
      <div style={activeTab.map(t => t === "hangar"
        ...
        <div style="padding: 16px; color: white; overflow-y: auto; flex: 1;">
          ...
          <div style={isLoggedIn.map(l => l ? "display: flex; gap: 12px; height: calc(100% - 40px);" : "display: none;")}>
            ...
            {/* Left: Aircraft List */}
            <div style="flex: 7; min-width: 0; background: #252532; border-radius: 8px; padding: 12px; overflow-y: auto;">
            ...
            <div style="flex: 13; min-width: 0; background: #252532; border-radius: 8px; padding: 12px; overflow-y: auto;">
                ...
                <div style="background: #1a1a24; border-radius: 8px; overflow: hidden; margin-bottom: 12px;">
                  <img
                    src={hangarSelectedAircraft.map(a => a?.aircraft_model
                      ? `coui://html_ui/efb_ui/efb_apps/AeroCorpOnline/Assets/aircraft/${a.aircraft_model.toUpperCase()}.jpg`
                      : "")}
                    alt=""
        ...
        <div style={hangarEditRegPopupOpen.map(show => show
          ? "position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.8); display: flex; align-items: center; justify-content: center; z-index: 1000;"
          : "display: none;")}>
