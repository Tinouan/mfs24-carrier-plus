-- =====================================================
-- V0.0 BASE SCHEMA INITIALIZATION
-- =====================================================
-- Creates core tables needed by the game API:
-- - game.users
-- - game.companies
...
CREATE TABLE IF NOT EXISTS game.companies (
    ...
    home_airport_ident VARCHAR(8) NOT NULL REFERENCES public.airports(ident),
    created_at TIMESTAMPTZ DEFAULT NOW() NOT NULL,
...
CREATE TABLE IF NOT EXISTS game.inventory_locations (
    ...
    airport_ident VARCHAR(8) REFERENCES public.airports(ident),
...
-- =====================================================
-- DONE - Base Schema Complete
-- =====================================================

SELECT 'Base schema created successfully - 6 tables + 3 triggers' AS status;
